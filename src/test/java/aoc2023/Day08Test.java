...
class Day08Test {
    ...
    void doPart1() throws Exception {
        ...
        assertThat(day.doPart1(day.readInput(getInputFilename()))).isEqualTo("2");
        assertThat(day.doPart1(day.readInput("day8_02.txt"))).isEqualTo("6");
    }
    ...
    void doPart2() throws Exception {
        ...
        assertThat(day.doPart2(day.readInput("day8_03.txt"))).isEqualTo("6");
    }
