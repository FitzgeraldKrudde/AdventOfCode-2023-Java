...
class Day10Test {
    ...
    void doPart1() throws Exception {
        ...
        assertThat(day.doPart1(day.readInput(getInputFilename()))).isEqualTo("4");
        assertThat(day.doPart1(day.readInput("day10_2.txt"))).isEqualTo("8");
    }
    ...
    void doPart2() throws Exception {
        ...
        assertThat(day.doPart2(day.readInput("day10_3.txt"))).isEqualTo("4");
        assertThat(day.doPart2(day.readInput("day10_4.txt"))).isEqualTo("4");
        assertThat(day.doPart2(day.readInput("day10_5.txt"))).isEqualTo("8");
        assertThat(day.doPart2(day.readInput("day10_6.txt"))).isEqualTo("10");
    }
